<template>
  <section class="" v-if="isSectionVisible">
    <div class="flex items-center justify-between gap-x-6  px-6 py-3.5 sm:pr-2.5 lg:pl-8 "
      style="background-color: #5DB8AD;">
      ...
      <p class="flex text-sm leading-6 text-white">
        ...
        <a href="#">
          <strong  v-if="isboldText" class="font-semibold">{{ title_bold }}&nbsp;</strong>{{ title }}&nbsp;&nbsp;<strong class="font-semibold">{{
            boldSub_title }}</strong>&nbsp; <i class="fas fa-arrow-right"></i>
        </a>
      </p>
      <div class="flex items-center justify-center">
        ...
        <a class="text-white" data-te-alert-dismiss aria-label="Close" @click="hideSection">
